        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="relative h-full flex items-center justify-center">
                        <div className="relative w-full max-w-md flex flex-col items-center">
                            ...
                            <div className="w-full relative mb-8">
                                <div className="text-center mb-2 font-mono text-xs text-slate-500">ESTIMATE REQUEST (ANGI/FB)</div>
                            ...
                            <div className="relative w-32 h-48 border-2 border-slate-700 rounded-xl p-2 flex justify-between">
                                ...
                                <div className={`absolute top-1/4 right-[calc(100%+0.5rem)] transition-all duration-500 z-10 ${activeStage === 0 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4'}`}>
                                    <span className="text-red-400 font-bold font-mono text-[10px] bg-red-400/10 px-2 py-1 rounded border border-red-400/20 whitespace-nowrap shadow-lg backdrop-blur-md">NO SHOW</span>
                                </div>
                                ...
                                <div className={`absolute top-2/4 left-[calc(100%+0.5rem)] transition-all duration-500 z-10 ${activeStage === 1 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>
                                    <span className="text-red-400 font-bold font-mono text-[10px] bg-red-400/10 px-2 py-1 rounded border border-red-400/20 whitespace-nowrap shadow-lg backdrop-blur-md">GHOSTED</span>
                                </div>
                            ...
                            <div className="w-full mt-8">
                                <div className={`text-center font-mono text-sm font-bold transition-colors duration-500 border-t pt-4 ${activeStage === 2 ? 'text-emerald-400 border-emerald-500/30' : 'text-slate-600 border-slate-800'}`}>
                                    {activeStage === 2 ? "JOB BOOKED: PROFIT SECURED" : "REVENUE LEAKING..."}
                                </div>
                            </div>
                        </div>
                    </div>
          ...
          <div className="order-1 lg:order-2 py-12 flex flex-col gap-48">
            ...
            <div ref={text0Ref} className={`transition-all duration-500 ${activeStage === 0 ? 'opacity-100 blur-0 scale-100' : 'opacity-30 blur-sm scale-95'}`}>
              <span className="text-red-500 font-mono text-sm font-bold tracking-widest mb-2 block">THE_NIGHTMARE</span>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                The No-Show Nightmare
              </h2>
              <p className="text-slate-400 text-lg leading-relaxed mb-6">
                 You pay for the lead and the gas. Your rep drives 45 mins... and nobody is home. Or they are renters who can't buy. You are losing 30% of revenue to poor screening.
              </p>
              <div className="inline-block p-4 bg-red-500/10 border border-red-500/20 rounded text-red-400 font-mono text-xs">
                ⚠️ FACT: 30% of leads are unqualified renters.
              </div>
            </div>
            ...
            <div ref={text1Ref} className={`transition-all duration-500 ${activeStage === 1 ? 'opacity-100 blur-0 scale-100' : 'opacity-30 blur-sm scale-95'}`}>
              <span className="text-red-500 font-mono text-sm font-bold tracking-widest mb-2 block">THE_GHOST</span>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Quote Sent & Vanished
              </h2>
              <p className="text-slate-400 text-lg leading-relaxed mb-6">
                 Or worse, you send the estimate, and the homeowner vanishes. You are losing revenue because you don't have time to chase them down.
              </p>
              <div className="inline-block p-4 bg-red-500/10 border border-red-500/20 rounded text-red-400 font-mono text-xs">
                ⚠️ ALERT: "I'll think about it" usually means "I'm shopping around."
              </div>
            </div>
             ...
             <div ref={text2Ref} className={`transition-all duration-500 ${activeStage === 2 ? 'opacity-100 blur-0 scale-100' : 'opacity-30 blur-sm scale-95'}`}>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                The <span className="text-emerald-500">Arrival</span> Protocol
              </h2>
              <p className="text-slate-300 text-lg leading-relaxed mb-6">
                We send automated appointment reminders 24h and 1h before the estimate. We even text them a photo of the sales rep so they feel safe opening the door. No-show rates drop to near zero.
              </p>
