          ...
          {!isSubmitted ? (
            <>
              <div className="flex items-center gap-2 mb-2">
                 ...
                 <h2 className="text-2xl font-bold text-white">Automate My Estimates</h2>
              </div>
              <p className="text-slate-400 mb-6 text-sm">
                Fill out the details below. We'll analyze your current lead flow and show you how much profit you are leaving on the table.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Business Name */}
                <div>
                  <label htmlFor="company" className="block text-xs font-mono text-slate-400 uppercase mb-1">Business Name *</label>
                  <input 
                    type="text" 
                    id="company"
                    required
                    className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all placeholder:text-slate-600"
                    placeholder="Doe Roofing & Siding"
                  />
                </div>
                ...
                {/* Monthly Volume */}
                <div>
                  <label htmlFor="volume" className="block text-xs font-mono text-slate-400 uppercase mb-1">Monthly Estimates</label>
                   <select 
                      id="volume"
                    ...
                    >
                      <option value="20-50">20 - 50 Estimates / mo</option>
                      <option value="50-100">50 - 100 Estimates / mo</option>
                      <option value="100-200">100 - 200 Estimates / mo</option>
                      <option value="200+">200+ Estimates / mo</option>
                    </select>
                </div>
