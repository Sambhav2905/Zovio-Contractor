      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          <Step 
            ...
            title="The Audit"
            date="T-MINUS 0"
            description="We map your current leakage points. We analyze your 'Speed-to-Lead' and no-show rates to identify exactly where profit is falling out."
          />
          <Step 
            number="02"
            title="Installation"
            date="T+48 HOURS"
            description="We build the workflows, connect to your CRM (ServiceTitan, Jobber, etc.), and configure the 'Arrival Protocol'. No disruption to your current jobs."
          />
          <Step 
            number="03"
            title="Launch & Handoff"
            date="T+14 DAYS"
            description="We flip the switch. Your office team gets a training session on how to handle the automated bookings. We monitor the system for 7 days to ensure stability."
            isLast={true}
          />
        </div>
